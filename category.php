...
<h1 class="heading"><?php $category = $_GET['category']; 
if ($category === "facewash") { echo "Face Wash"; }
if ($category === "cream") { echo "Cream"; }
if ($category === "hairoil") { echo "hair oil"; }
if ($category === "lipstic") { echo "lipstic"; }
if ($category === "nailpolish") { echo "Nail Polish"; }?></h1>
